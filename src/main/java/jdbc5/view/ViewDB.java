...
class ViewDBFrame extends JFrame{
    ...
    public ViewDBFrame(){
        ...
        nextButton.addActionListener(event-> deleteRow());
        buttonPanel.add(deleteButton);

        saveButton = new JButton("Save");
        nextButton.addActionListener(event-> saveChanges());
    ...
    public void showTable(String tableName, Connection conn){
        try(Statement stat = conn.createStatement(); ResultSet result = stat.executeQuery(
