...
public class ZonedTimes {
    public static void main(String[] args) {
        ...
        ZonedDateTime ambigouos = ZonedDateTime.of(LocalDate.of(2013, 10, 27),
                LocalTime.of(2, 30), ZoneId.of("Europe/Berlin"));
        ZonedDateTime anHourLater = ambigouos.plusHours(1);
        System.out.println("ambigouos: " + ambigouos);
        ...
        ZonedDateTime nextMeeting = meeting.plus(Duration.ofDays(7));  // incorrect
        System.out.println("nextMeeting: " +nextMeeting);
        nextMeeting = meeting.plus(Period.ofDays(7));  // correct!
        System.out.println("nextMeeting: " +nextMeeting);
